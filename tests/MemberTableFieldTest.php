...
class MemberTableFieldTest extends FunctionalTest
{
    ...
    public static $fixture_file = 'cms/tests/MemberTableFieldTest.yml';
    
    
    public function testLimitsToMembersInGroup()
    {
    ...
    public function testShowsAllMembersWithoutGroupParameter()
    {
        $member1 = $this->objFromFixture('Member', 'member1');
        $member2 = $this->objFromFixture('Member', 'member2');
        $member3 = $this->objFromFixture('Member', 'member3');
    ...
    public function testDeleteWithGroupOnlyDeletesRelation()
    {
        $member1 = $this->objFromFixture('Member', 'member1');
        $group1 = $this->objFromFixture('Group', 'group1');
    ...
    public function testDeleteWithoutGroupDeletesFromDatabase()
    {
        $member1 = $this->objFromFixture('Member', 'member1');
