...
class CommentTableField extends ComplexTableField
{
    ...
    public function __construct($controller, $name, $sourceClass, $mode, $fieldList, $detailFormFields = null, $sourceFilter = "", $sourceSort = "Created", $sourceJoin = "")
    {
        $this->mode = $mode;
...
class CommentTableField_ItemRequest extends ComplexTableField_ItemRequest
{
     ...
     */
    public function handlePageCommentAction($request)
    {
