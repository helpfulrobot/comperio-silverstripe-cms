...
abstract class ModelAdmin extends LeftAndMain
{
     ...
     */
    public function getCollectionControllerClass($model)
    {
     ...
     */
    public function getRecordControllerClass($model)
    {
        $models = $this->getManagedModels();
...
class ModelAdmin_CollectionController extends Controller
{
    ...
    {
        if ($this->showImportForm === null) {
            return $this->parentController->showImportForm;
        } else {
...
class ModelAdmin_RecordController extends Controller
{
    ...
    public static $allowed_actions = array('edit', 'view', 'EditForm', 'ViewForm');
    
    public function __construct($parentController, $request, $recordID = null)
    {
