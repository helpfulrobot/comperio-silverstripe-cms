...
class LeftAndMain extends Controller
{
    ...
    */
    public static $help_link = 'http://userhelp.silverstripe.org';
...
JS;
    ...
    public function deleteTreeNodeJS($page)
    {
        ...
        if (!$page || (!isset($page->ID) && !isset($page->OldID))) {
            return false;
        }
...
JS;
     ...
     * @var String
     */
    public static $application_name = 'SilverStripe CMS';
     ...
     * @var String
     */
    public static $application_logo_text = 'SilverStripe';
     ...
     */
    public static $application_link = "http://www.silverstripe.org/";
    public static function setApplicationName($name, $logoText = null, $link = null)
    {
     ...
     * @return String
     */
    public function getApplicationLogoText()
    {
    ...
    public function SectionTitle()
    {
        ...
        foreach ($menu as $menuItem) {
            if ($menuItem->LinkingMode == 'current') {
     ...
     * @var unknown_type
     */
    public static $application_logo = 'cms/images/mainmenu/logo.gif';
     ...
     * @var String
     */
    public static $application_logo_style = '';
     ...
     */
    public static function setLogo($logo, $logoStyle)
    {
     ...
     */
    public static function set_loading_image($loadingImage)
    {
     ...
     */
    public function callPageMethod($data, $form)
    {
