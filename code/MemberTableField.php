...
class MemberTableField extends ComplexTableField
{
    ...
    public static $data_class = 'Member';
     ...
     */
    public function __construct($controller, $name, $group = null, $members = null, $hidePassword = true)
    {
    ...
    public function getParentIdName($childClass, $parentClass)
    {
        return 'GroupID';
    }
     ...
     */
    public function memberListWithGroupID($members, $group)
    {
