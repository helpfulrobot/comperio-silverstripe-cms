...
class AssetAdmin extends LeftAndMain
{
    ...
    public static $url_segment = 'assets';
    
    public static $url_rule = '/$Action/$ID';
    
    public static $menu_title = 'Files & Images';
...
JS
     ...
     * @return String
     */
    public function UploadMetadataHtml()
    {
        if (!self::$metadata_upload_enabled) {
            return;
        }
        ...
        foreach ($fields as $field) {
            $fieldHtml = $fieldHtml . $field->FieldHolder();
        }
