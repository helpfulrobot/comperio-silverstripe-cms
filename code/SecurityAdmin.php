...
class SecurityAdmin extends LeftAndMain implements PermissionProvider
{
    ...
    public static $url_segment = 'security';
    
    public static $url_rule = '/$Action/$ID/$OtherID';
    
    public static $menu_title = 'Security';
     ...
     * @var Array
     */
    public static $hidden_permissions = array();
    ...
    public function EditedMember()
    {
        if (Session::get('currentMember')) {
            return DataObject::get_by_id('Member', (int) Session::get('currentMember'));
        }
    }
