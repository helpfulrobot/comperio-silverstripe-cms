...
class PageCommentInterface extends RequestHandler
{
     ...
     * @var bool
     */
    public static $comments_require_login = false;
     ...
     * @var string 
     */
    public static $comments_require_permission = "";
     ...
     * @var bool
     */
    public static $use_ajax_commenting = true;
     ...
     */
    public static $show_comments_when_disabled = true;
     ...
     * @since 2.4 
     */
    public static $order_comments_by = "\"Created\" DESC";
     ...
     */
    public function __construct($controller, $methodName, $page)
    {
     ...
     */
    public static function set_comments_require_login($state)
    {
     ...
     */
    public static function set_comments_require_permission($permission)
    {
     ...
     */
    public static function set_show_comments_when_disabled($state)
    {
     ...
     * @param String
     */
    public static function set_order_comments_by($order)
    {
     ...
     * @param bool
     */
    public static function set_use_ajax_commenting($state)
    {
     ...
     */
    public static function CanPostComment()
    {
     ...
     * @return bool
     */
    public function PostingRequiresPermission()
    {
...
class PageCommentInterface_Controller extends ContentController
{
    ...
    public function newspamquestion()
    {
        if (Director::is_ajax()) {
